...
This repository contains basic Jupyter Notebooks to use the datasets provided for the ShoreShop 3.0. However and due to teh nature of this ShoreShop, the data can be download through the webpage https://shoreshop3.netlify.app/data. 
